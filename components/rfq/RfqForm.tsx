    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 card p-4 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="flex flex-wrap gap-2">
            {vendors.map((v) => (
              <label key={v.id} className={`cursor-pointer rounded-lg border px-3 py-1.5 text-sm ${selected.has(v.id) ? "border-navy bg-navy/10 font-semibold text-navy" : "border-line text-grey hover:bg-grey/5"}`}>
      ...
      <div className="overflow-x-auto card">
        ...
        <div className="border-t border-line px-3 py-2">
          <button type="button" className="rounded-lg border border-line px-3 py-1 text-xs font-semibold text-grey hover:bg-grey/10"
